#!/bin/bash
echo "--- INICIANDO RENDERIZAÇÃO INDUSTRIAL (v12.15) ---"
...
# Entrando no "Escritório" da Lana para carregar as Configs Locais
cd /workspace/latentsync
echo "--- INICIANDO INFERÊNCIA CRYSTAL CLEAR (v8.2) ---"

# Execução do LatentSync do diretório raiz usando 'scripts.inference' em vez de 'latentsync.scripts.inference'
