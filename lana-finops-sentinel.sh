...
while true; do
    ...
    # Se acumulou 2 ciclos seguidos (30-60 segundos de ZERO processamento), ceifar a máquina
    if [ "$IDLE_CYCLES" -ge 2 ]; then
        echo "Sentinela detectou 60s de Ociosidade Plena da GPU. Executando Custo Zero: Hibernando."
        sudo poweroff
    fi
done
